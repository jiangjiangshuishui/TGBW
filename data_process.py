...
def prepare_intersection_data(cancerType):
    ppi, ppi_nodes = load_network('C:/Users/11402/Desktop/NIGCNDriver-master/data/MULTINET.txt')
    rna_file = f'C:/Users/11402/Desktop/NIGCNDriver-master/{cancerType}/orig_data/exp.txt'
    snp_file = f'C:/Users/11402/Desktop/NIGCNDriver-master/{cancerType}/orig_data/mut.txt'
    ...
    ppi.to_csv(path_or_buf=f'C:/Users/11402/Desktop/NIGCNDriver-master/{cancerType}/orig_data/MULTINET.txt', sep='\t', header=False, index=False)
...
def create_mutation_and_driver_matrices(cancerType):
    ...
    gold_drivers_file = f'C:/Users/11402/Desktop/NIGCNDriver-master/{cancerType}/Cancer_List/driver_list.txt'
    gold_drivers = pd.read_table(filepath_or_buffer=gold_drivers_file, header=None, index_col=None, names=['name'])
    ...
    ppi_file = f'C:/Users/11402/Desktop/NIGCNDriver-master/{cancerType}/orig_data/MULTINET.txt'
    ppi, ppi_nodes = load_network(ppi_file)
    remv_mut_ls = []
    for g in otly_g_ls:
    ...
    output_dir = f'C:/Users/11402/Desktop/NIGCNDriver-master/{cancerType}/Cancer_List/'
    P.to_csv(path_or_buf=output_dir + 'mut_driver3.txt', sep='\t', header=True, index=True)
    exp.to_csv(path_or_buf=output_dir + 'exp3.txt', sep='\t', header=True, index=True)
    snp.to_csv(path_or_buf=output_dir + 'mut3.txt', sep='\t', header=True, index=True)
